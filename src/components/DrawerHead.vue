...
<template>
    <div class="flex items-center gap-5 mb-5">
            <svg @click="closeDrawer" class="opacity-50 cursor-pointer rotate-180 hover:opacity-100 transition ease duration-300" width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
